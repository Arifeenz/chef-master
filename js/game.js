...
const recipes = {
  ...
  "🥗 สลัดผัก": ["🥬 ผัก"],
  "🐟 ปลาทอด": ["🐟 ปลา"],
  "🥛 นมถั่วเหลือง": ["🌱 ถั่วเหลือง"],
  "🍌 กล้วยตาก": ["🍌 กล้วยหิน"],
  "🍠 มันเผา": ["🍠 มัน"],
  "🌽 ข้าวโพดต้ม": ["🌽 ข้าวโพด"],
  "🥔 มันฝรั่งต้ม": ["🥔 มันฝรั่ง"],
  "🍊 น้ำส้ม": ["🍊 ส้ม"],
  "🥩 เนื้อย่าง": ["🐂 เนื้อวัว"],
  ...
  "🥚 ไข่เจียว": ["🥚 ไข่", "🛢️ น้ำมัน"],
  "🍙 ข้าวปั้น": ["🍚 ข้าวสวย", "🌿 สาหร่าย"],
  "🍟 เฟรนช์ฟรายส์": ["🥔 มันฝรั่ง", "🛢️ น้ำมัน"],
  "🌮 ทาโก้ผัก": ["🥬 ผัก", "🌾 แป้ง"],
  "🍔 แฮมเบอร์เกอร์ไก่": ["🍗 เนื้อไก่", "🥬 ผัก"],
  "🥒 แตงกวาดอง": ["🥒 แตงกวา", "🧂 น้ำปลา"],
  "🥤 น้ำสมุนไพร": ["🌿 สมุนไพรซอย", "🍯 น้ำตาลปี๊บ"],

  // ====== เลเวล 3: ง่าย–กลาง (3 วัตถุดิบ) ======
  "🍚 ข้าวยำปักษ์ใต้": ["🍚 ข้าวสวย", "🌿 สมุนไพรซอย", "🐟 น้ำบูดู"],
  ...
  "🍜 ราเมน": ["🍜 เส้นบะหมี่", "🥚 ไข่", "🧄 กระเทียม"],
  "🍝 สปาเก็ตตี้": ["🍝 เส้นสปาเก็ตตี้", "🧄 กระเทียม", "🍅 มะเขือเทศ"],
  "🍛 ข้าวแกงกะหรี่": ["🍚 ข้าวสวย", "🥔 มันฝรั่ง", "🍛 ผงกะหรี่"],
  "🍢 ลูกชิ้นปิ้ง": ["🐟 ลูกชิ้นปลา", "🌶️ พริก", "🧄 กระเทียม"],
  "🥬 ผัดผักรวม": ["🥬 ผัก", "🥕 แครอท", "🌽 ข้าวโพด"],
  ...
  "🐟 ยำปลากระป๋อง": ["🐟 ปลากระป๋อง", "🌾 ตะไคร้", "🍃 ใบมะกรูด", "🍋 น้ำมะนาว"],
  "🥚 ไข่ลูกเขย": ["🥚 ไข่ต้ม", "🍯 น้ำตาลปี๊บ", "🍋 น้ำมะขามเปียก", "🧅 หอมเจียว"],
  "🍜 ผัดไทยกุ้ง": ["🍜 เส้นบะหมี่", "🍤 กุ้ง", "🥚 ไข่", "🌿 ถั่วฝักยาว"],
  "🍲 ต้มข่าไก่": ["🍗 เนื้อไก่", "🥥 กะทิ", "🌾 ตะไคร้", "🍋 น้ำมะนาว"],
  "🥬 แกงส้มผักรวม": ["🥬 ผักพื้นบ้าน", "🌶️ เครื่องแกงใต้", "🐟 ปลา", "🍋 น้ำมะนาว"],
  "🍗 ข้าวมันไก่": ["🍚 ข้าวสวย", "🍗 เนื้อไก่", "🧄 กระเทียม", "🥒 แตงกวา"],
  "🥟 เกี๊ยวน้ำ": ["🍤 กุ้ง", "🌾 แป้ง", "🧄 กระเทียม", "🥬 ผัก"],
  "🍲 โจ๊กหมู": ["🍚 ข้าวสวย", "🐖 หมูสับ", "🥚 ไข่", "🧄 กระเทียม"],
  "🍛 แกงเผ็ดเป็ดย่าง": ["🦆 เป็ดย่าง", "🥥 กะทิ", "🌶️ พริกแกงเผ็ด", "🍃 ใบมะกรูด"],
  "🍤 กุ้งอบวุ้นเส้น": ["🍤 กุ้ง", "🍜 วุ้นเส้น", "🌾 ตะไคร้", "🧄 กระเทียม"],
  "🍗 ไก่ผัดเม็ดมะม่วง": ["🍗 เนื้อไก่", "🥜 เม็ดมะม่วง", "🌶️ พริก", "🧅 หอมใหญ่"],
  "🍛 ข้าวราดผัดพริกแกง": ["🍚 ข้าวสวย", "🐖 หมูสับ", "🌶️ เครื่องแกงใต้", "🥬 ผัก"],
  "🍜 ก๋วยเตี๋ยวเรือ": ["🍜 เส้นบะหมี่", "🐂 เนื้อวัว", "🥬 ผัก", "🧄 กระเทียม"],
  "🍲 ซุปผักรวม": ["🥬 ผัก", "🥕 แครอท", "🌽 ข้าวโพด", "🍅 มะเขือเทศ"],
  "🥔 แกงกะหรี่ญี่ปุ่น": ["🥔 มันฝรั่ง", "🥕 แครอท", "🍚 ข้าวสวย", "🍛 ผงกะหรี่"],
  "🍗 ไก่อบสมุนไพร": ["🍗 เนื้อไก่", "🌿 สมุนไพรซอย", "🧄 กระเทียม", "🍋 น้ำมะนาว"],
  ...
  "🍛 ข้าวผัดอเมริกัน": ["🍚 ข้าวสวย", "🥕 แครอท", "🌭 ไส้กรอก", "🍗 ปีกไก่ทอด", "🧅 หอมใหญ่"],
  "🐂 ซุปหางวัว": ["🐂 หางวัว", "🍃 ใบมะกรูด", "🌾 ตะไคร้", "🍅 มะเขือเทศ", "🍋 น้ำมะนาว"],
  "🍜 บะหมี่ไก่แดง": ["🍗 อกไก่", "🧄 กระเทียม", "🐟 ลูกชิ้นปลา", "🍜 เส้นบะหมี่", "🥚 ไข่ต้ม"],
  "🍝 ลาซานญ่า": ["🍝 เส้นลาซานญ่า", "🧄 กระเทียม", "🍅 มะเขือเทศ", "🧅 หอมใหญ่", "🧀 ชีส"],
  "🍣 ซูชิรวม": ["🍚 ข้าวสวย", "🐟 ปลา", "🥒 แตงกวา", "🌿 สาหร่าย", "🥚 ไข่"],
  "🍤 พะแนงกุ้ง": ["🍤 กุ้ง", "🥥 กะทิ", "🌶️ พริกแกง", "🍃 ใบมะกรูด", "🧄 กระเทียม"],
  "🥟 ขนมจีบกุ้ง": ["🍤 กุ้ง", "🌾 แป้ง", "🧄 กระเทียม", "🥕 แครอท", "🥬 ผัก"],
  "🍛 มัสมั่นไก่": ["🍗 เนื้อไก่", "🥔 มันฝรั่ง", "🥥 กะทิ", "🌶️ เครื่องแกงมัสมั่น", "🥜 ถั่วลิสง"],
  "🍲 ก๋วยจั๊บญวน": ["🍜 เส้นข้าว", "🐖 หมูสับ", "🧄 กระเทียม", "🥚 ไข่", "🥬 ผัก"],
  "🍤 กุ้งเผา": ["🍤 กุ้ง", "🧄 กระเทียม", "🌶️ พริก", "🍋 น้ำมะนาว", "🥬 ผัก"],
  "🍜 ราดหน้า": ["🍜 เส้นใหญ่", "🐖 หมูสับ", "🥬 คะน้า", "🧄 กระเทียม", "🥚 ไข่"],
  "🥗 ซีซาร์สลัด": ["🥬 ผักกาด", "🧄 กระเทียม", "🧅 หอมใหญ่", "🥓 เบคอน", "🧀 ชีส"],
  "🍗 ไก่ย่าง": ["🍗 เนื้อไก่", "🌾 ขมิ้น", "🧄 กระเทียม", "🌶️ พริก", "🥬 ผัก"],
  "🍜 เย็นตาโฟ": ["🍜 เส้นบะหมี่", "🐟 ลูกชิ้นปลา", "🥬 ผัก", "🥚 ไข่", "🍅 ซอสแดง"],
  "🍚 ข้าวหน้าเป็ด": ["🍚 ข้าวสวย", "🦆 เป็ดย่าง", "🥬 ผัก", "🧄 กระเทียม", "🥢 ซีอิ๊ว"],
  "🍛 ข้าวผัดปู": ["🍚 ข้าวสวย", "🦀 ปู", "🥚 ไข่", "🧄 กระเทียม", "🥬 ผัก"],
  "🥘 ปอเปี๊ยะทอด": ["🌾 แป้ง", "🥬 ผัก", "🥕 แครอท", "🧄 กระเทียม", "🍤 กุ้ง"],
};
